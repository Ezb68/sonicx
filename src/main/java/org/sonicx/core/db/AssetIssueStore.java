...
import static org.sonicx.core.config.Parameter.DatabaseConstants.ASSET_ISSUE_COUNT_LIMIT_MAX;
...
@Slf4j(topic = "DB")
@Component
public class AssetIssueStore extends SonicxStoreWithRevoking<AssetIssueCapsule> {
