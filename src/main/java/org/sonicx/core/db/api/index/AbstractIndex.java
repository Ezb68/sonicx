...
import org.sonicx.core.db.api.index.Index.Iface;
import org.sonicx.core.db.common.WrappedByteArray;
import org.sonicx.core.db.common.WrappedResultSet;
...
public abstract class AbstractIndex<E extends ProtoCapsule<T>, T> implements Iface<T> {
  ...
  protected ISonicxChainBase<E> database;
  ...
  public AbstractIndex(ISonicxChainBase<E> database) {
