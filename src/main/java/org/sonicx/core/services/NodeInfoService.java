...
import org.sonicx.common.entity.NodeInfo.ConfigNodeInfo;
import org.sonicx.common.entity.NodeInfo.MachineInfo;
import org.sonicx.common.entity.NodeInfo.MachineInfo.DeadLockThreadInfo;
import org.sonicx.common.entity.NodeInfo.MachineInfo.MemoryDescInfo;
import org.sonicx.common.entity.PeerInfo;
...
import org.sonicx.core.services.WitnessProductBlockService.CheatWitnessInfo;
  ...
  private void setConnectInfo(NodeInfo nodeInfo) {
    ...
    for (PeerConnection peerConnection : syncPool.getActivePeers()) {
      ...
      ReasonCode reasonCode = peerConnection.getNodeStatistics()
          .getSonicxLastLocalDisconnectReason();
      peerInfo.setLocalDisconnectReason(reasonCode == null ? "" : reasonCode.toString());
      reasonCode = peerConnection.getNodeStatistics().getSonicxLastRemoteDisconnectReason();
