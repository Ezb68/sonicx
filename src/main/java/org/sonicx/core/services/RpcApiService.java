...
import org.sonicx.api.DatabaseGrpc.DatabaseImplBase;
...
import org.sonicx.api.GrpcAPI.BlockReference;
...
import org.sonicx.api.WalletGrpc.WalletImplBase;
import org.sonicx.api.WalletSolidityGrpc.WalletSolidityImplBase;
...
import org.sonicx.protos.Contract.UpdateBrokerageContract;
...
import org.sonicx.protos.Protocol.NodeInfo;
...
public class RpcApiService implements Service {
  ...
  public class DatabaseApi extends DatabaseImplBase {
    ...
    @Override
    public void getBlockReference(org.sonicx.api.GrpcAPI.EmptyMessage request,
        io.grpc.stub.StreamObserver<org.sonicx.api.GrpcAPI.BlockReference> responseObserver) {
  ...
  public class WalletSolidityApi extends WalletSolidityImplBase {
    ...
    public void getDelegatedResourceAccountIndex(BytesMessage request,
        StreamObserver<org.sonicx.protos.Protocol.DelegatedResourceAccountIndex> responseObserver) {
      responseObserver
  ...
  public class WalletApi extends WalletImplBase {
    ...
    private void checkVoteWitnessAccount(VoteWitnessContract req) {
      ...
      Preconditions.checkArgument(account.getSonicxPower() < votesCount,
          "sonicx power[" + account.getSonicxPower() + "] <  VotesCount[" + votesCount + "]");
...
//    }
    ...
    @Override
    public void deployContract(org.sonicx.protos.Contract.CreateSmartContract request,
