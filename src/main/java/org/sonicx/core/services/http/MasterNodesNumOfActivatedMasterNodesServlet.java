...
@Component
@Slf4j(topic = "API")
public class MasterNodesNumOfActivatedMasterNodesServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        GrpcAPI.TransactionExtention result = masternodeController.numOfActivatedMasternodes(contractAddress);
