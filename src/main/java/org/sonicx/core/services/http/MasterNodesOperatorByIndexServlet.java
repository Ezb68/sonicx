...
@Component
@Slf4j(topic = "API")
public class MasterNodesOperatorByIndexServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        operator = jsonObject.getString("address");

        GrpcAPI.TransactionExtention result = masternodeController.mnOperatorIndexes(contractAddress, operator);
