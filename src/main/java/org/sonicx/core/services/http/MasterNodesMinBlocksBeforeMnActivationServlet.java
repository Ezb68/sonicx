...
@Component
@Slf4j(topic = "API")
public class MasterNodesMinBlocksBeforeMnActivationServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        GrpcAPI.TransactionExtention result = masternodeController.minBlocksBeforeMnActivation(contractAddress);
