...
@Component
@Slf4j(topic = "API")
public class MasterNodesMinimumCollateralServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        TransactionExtention result = masternodeController.minimumCollateral(contractAddress);
