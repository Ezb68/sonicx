...
@Component
@Slf4j(topic = "API")
public class MasterNodesGetHistorySizeServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        TransactionExtention result = masternodeController.getMasternodesHistorySize(contractAddress);
