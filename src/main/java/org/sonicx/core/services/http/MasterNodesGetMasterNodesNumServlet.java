...
@Component
@Slf4j(topic = "API")
public class MasterNodesGetMasterNodesNumServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        TransactionExtention result = masternodeController.getMasternodesNum(contractAddress);
