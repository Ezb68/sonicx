...
import org.sonicx.common.overlay.message.MessageFactory;
import org.sonicx.core.exception.P2pException;

/**
 * msg factory.
 */
public class SonicxMessageFactory extends MessageFactory {

  @Override
  public SonicxMessage create(byte[] data) throws Exception {
    try {
      byte type = data[0];
  ...
  private SonicxMessage create(byte type, byte[] packed) throws Exception {
