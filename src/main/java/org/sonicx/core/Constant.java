...
public class Constant {
  ...
  public static final long DOLE_PER_ENERGY = 100; // 1 ud = 100 DROP = 100 * 10^-6 SOX
  public static final long ENERGY_LIMIT_IN_CONSTANT_TX = 3_000_000L; // ref: 1 ud = 1 energy
