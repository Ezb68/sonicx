...
import org.sonicx.core.db.CodeStore;
import org.sonicx.core.db.ContractStore;
import org.sonicx.core.db.DelegatedResourceStore;
import org.sonicx.core.db.DynamicPropertiesStore;
import org.sonicx.core.db.Manager;
import org.sonicx.core.db.ProposalStore;
import org.sonicx.core.db.TransactionStore;
...
public class DepositImpl implements Deposit {
  ...
  public synchronized void putStorageValue(byte[] address, DataWord key, DataWord value) {
    address = convertToSonicxAddress(address);
