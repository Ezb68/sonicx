...
import static org.sonicx.common.runtime.utils.SolidityType.IntType.decodeInt;
import static org.sonicx.common.runtime.utils.SolidityType.IntType.encodeInt;
...
public class Abi extends ArrayList<Abi.Entry> {
    ...
    public Function getFunction(final String name) {
        return findFunction(f -> f.name.equalsIgnoreCase(name));
    }
