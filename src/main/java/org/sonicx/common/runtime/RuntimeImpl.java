...
import static org.sonicx.common.runtime.utils.MUtil.transferToken;
...
import org.sonicx.common.runtime.vm.VMUtils;
import org.sonicx.common.runtime.vm.program.InternalTransaction;
import org.sonicx.common.runtime.vm.program.InternalTransaction.ExecutorType;
...
import org.sonicx.common.runtime.vm.program.ProgramPrecompile;
...
public class RuntimeImpl implements Runtime {
  ...
  public long getTotalEnergyLimitWithFixRatio(AccountCapsule creator, AccountCapsule caller,
    ...
    if (Arrays.equals(creator.getAddress().toByteArray(), caller.getAddress().toByteArray())) {
      ...
      // which will cost the feeLimit SOX when the creator's frozen energy is 0.
      return callerEnergyLimit;
    }
  ...
  public void finalization() {
    if (StringUtils.isEmpty(runtimeError)) {
      for (DataWord contract : result.getDeleteAccounts()) {
        deposit.deleteContract(convertToSonicxAddress((contract.getLast20Bytes())));
      }
    }
