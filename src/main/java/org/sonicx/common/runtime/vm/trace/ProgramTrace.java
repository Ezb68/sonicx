 ...
 */
package org.sonicx.common.runtime.vm.trace;

import static java.lang.String.format;
import static org.sonicx.common.runtime.utils.MUtil.convertToSonicxAddress;
import static org.sonicx.common.runtime.vm.trace.Serializers.serializeFieldsOnly;
...
public class ProgramTrace {
    ...
    public ProgramTrace(VMConfig config, ProgramInvoke programInvoke) {
        if (programInvoke != null && config.vmTrace()) {
            contractAddress = Hex.toHexString(convertToSonicxAddress(programInvoke.getContractAddress().getLast20Bytes()));
        }
    }
