...
public class PeerServer {
  ...
  public SonicxChannelInitializer sonicxChannelInitializer;
  ...
  public void start(int port) {
    ...
    sonicxChannelInitializer = ctx.getBean(SonicxChannelInitializer.class, "");

    sonicxChannelInitializer.setNodeImpl(p2pNode);
    ...
    try {
      ...
      b.childHandler(sonicxChannelInitializer);
