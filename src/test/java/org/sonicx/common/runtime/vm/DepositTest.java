...
/*  pragma solidity ^0.4.0;
  ...
  public void loopCallTest()
    ...
    Runtime runtime = SVMTestUtils.processTransactionAndReturnRuntime(aTrx, DepositImpl.createRoot(manager), null);
    ...
    runtime = SVMTestUtils.processTransactionAndReturnRuntime(bTrx, DepositImpl.createRoot(manager), null);
    Assert.assertNull(runtime.getRuntimeError());
    ...
    byte[] triggerData = SVMTestUtils.parseABI("callBcallARevert(address,uint256,uint256)", params1);
