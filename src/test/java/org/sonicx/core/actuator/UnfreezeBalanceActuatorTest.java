...
public class UnfreezeBalanceActuatorTest {
  ...
  private Any getContractForCpu(String ownerAddress) {
    return Any.pack(
        Contract.UnfreezeBalanceContract.newBuilder()
            .setOwnerAddress(ByteString.copyFrom(ByteArray.fromHexString(ownerAddress)))
            .setResource(org.sonicx.protos.Contract.ResourceCode.ENERGY)
            .build());
  }
  ...
  public void testUnfreezeBalanceForBandwidth() {
    ...
    Assert.assertEquals(accountCapsule.getSonicxPower(), frozenBalance);
    ...
    try {
      ...
      Assert.assertEquals(owner.getSonicxPower(), 0L);
  ...
  public void testUnfreezeDelegatedBalanceForBandwidth() {
    ...
    Assert.assertEquals(frozenBalance, owner.getSonicxPower());
    ...
    Assert.assertEquals(0L, receiver.getSonicxPower());
    ...
    try {
      ...
      Assert.assertEquals(0L, ownerResult.getSonicxPower());
