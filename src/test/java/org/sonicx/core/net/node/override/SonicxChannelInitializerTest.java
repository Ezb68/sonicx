...
@Component
@Scope("prototype")
public class SonicxChannelInitializerTest extends ChannelInitializer<NioSocketChannel> {

  private static final Logger logger = LoggerFactory.getLogger("SonicxChannelInitializer");
  ...
  public SonicxChannelInitializerTest(String remoteId) {
