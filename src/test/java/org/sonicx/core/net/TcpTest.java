...
import static org.sonicx.core.net.message.MessageTypes.P2P_DISCONNECT;
import static org.sonicx.core.net.message.MessageTypes.P2P_HELLO;
import static org.sonicx.protos.Protocol.ReasonCode.DUPLICATE_PEER;
import static org.sonicx.protos.Protocol.ReasonCode.FORKED;
import static org.sonicx.protos.Protocol.ReasonCode.INCOMPATIBLE_CHAIN;
import static org.sonicx.protos.Protocol.ReasonCode.INCOMPATIBLE_VERSION;
...
import org.sonicx.common.overlay.message.P2pMessage;
import org.sonicx.common.overlay.message.P2pMessageFactory;
...
public class TcpTest {
  ...
  public TcpTest(SonicxApplicationContext context) {
  ...
  private void validResultCloseConnect(Channel channel) throws InterruptedException {
    ...
    Collection<PeerConnection> peerConnections = ReflectUtils
        .invokeMethod(sonicxNetDelegate, "getActivePeer");
