...
import org.sonicx.protos.Protocol.DisconnectMessageOrBuilder;
...
public class DisconnectMessageTest extends
   ...
   * <code>.protocol.ReasonCode reason = 1;</code>
   */
  public org.sonicx.protos.Protocol.ReasonCode getReason() {
    org.sonicx.protos.Protocol.ReasonCode result = org.sonicx.protos.Protocol.ReasonCode
        .valueOf(reason_);
    return result == null ? org.sonicx.protos.Protocol.ReasonCode.UNRECOGNIZED : result;
  }

  public org.sonicx.protos.Protocol.ReasonCode getName() {
    org.sonicx.protos.Protocol.ReasonCode result = org.sonicx.protos.Protocol.ReasonCode
        .valueOf(name_);
    return result == null ? org.sonicx.protos.Protocol.ReasonCode.UNRECOGNIZED : result;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (reason_ != org.sonicx.protos.Protocol.ReasonCode.REQUESTED.getNumber()) {
      output.writeEnum(1, reason_);
    }
    if (name_ != org.sonicx.protos.Protocol.ReasonCode.REQUESTED.getNumber()) {
