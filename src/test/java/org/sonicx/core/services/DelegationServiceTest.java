...
public class DelegationServiceTest {
  ...
  public DelegationServiceTest(SonicxApplicationContext context) {
  ...
  private void testPay(int cycle) {
    ...
    byte[] sr1 = Wallet.decodeFromBase58Check("SXYtFv2ax2oVixWdrz2tMiF1mjucBXEqJt");
  ...
  private void testWithdraw() {
    ...
    testPay(2);
    byte[] sr1 = Wallet.decodeFromBase58Check("SX2urn6u95nhGBSKonf8bPkZvo9ghpkaNq");
    AccountCapsule accountCapsule = manager.getAccountStore().get(sr1);
    byte[] sr27 = Wallet.decodeFromBase58Check("SXYtFv2ax2oVixWdrz2tMiF1mjucBXEqJt");
  ...
  public static void testGrpc() {
    ...
    builder.setValue(ByteString.copyFromUtf8("SXYtFv2ax2oVixWdrz2tMiF1mjucBXEqJt"));
    System.out
