...
public class ContractSrcToken038 {
  ...
  public void deployTransferTokenContract() {
    ...
    String code2 = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractSrcToken038_tokenTest");
    String abi2 = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractSrcToken038_tokenTest");
    ...
    String code = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractSrcToken038_BTest");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractSrcToken038_BTest");
