...
public class ContractSrcToken067 {
  ...
  public void test01DeployTransferTokenContract() {
    ...
    String code = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractSrcToken067_transferTokenContract");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractSrcToken067_transferTokenContract");
  ...
  public void test02DeployRevContract() {
    ...
    String code = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractSrcToken067_recieveTokenContract");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractSrcToken067_recieveTokenContract");
