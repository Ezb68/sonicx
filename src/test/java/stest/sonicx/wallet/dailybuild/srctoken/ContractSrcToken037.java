...
public class ContractSrcToken037 {
  ...
  public void deploy01TransferTokenContract() {
    ...
    String contractName = "receiveSrc10Test";
    String code = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractSrcToken037_receiveSrc10Test");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractSrcToken037_receiveSrc10Test");
    ...
    String code1 = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractSrcToken037_tokenTest");
    String abi1 = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractSrcToken037_tokenTest");
