...
import static org.sonicx.protos.Protocol.TransactionInfo.code.FAILED;
...
public class ContractSrcToken043 {
  ...
  public void test01DeployTransferTokenContract() {
    ...
    String code = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractSrcToken071_transferTokenContract");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractSrcToken071_transferTokenContract");
  ...
  public void test02DeployRevContract() {
    ...
    String code = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractSrcToken043_recieveTokenContract");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractSrcToken043_recieveTokenContract");
  ...
  public void test03TriggerContract() {
    ...
    // tokenId is 0, contract not have sox
    ...
    // tokenId is 0, account does not have sox
    ...
    // tokenId is 0, transfer contract has sox, transfer to a contract
    tokenId = Long.toString(0);
    tokenValue = Long.valueOf(1);
    ...
    //tokenId is 0, transfer contract has sox, transfer to normal account
    tokenId = Long.toString(0);
    tokenValue = Long.valueOf(1);
    callValue = Long.valueOf(1);
