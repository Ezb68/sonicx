...
public class ContractSrcToken036 {
  ...
  public void deploy01TransferTokenContract() {
    ...
    String code = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractSrcToken036_tokenTest");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractSrcToken036_tokenTest");
  ...
  public void deploy02TransferTokenContract() {
    ...
    String code1 = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractSrcToken036_transferTokenWithPureTest");
    String abi1 = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractSrcToken036_transferTokenWithPureTest");
  ...
  public void deploy04TransferTokenContract() {
    ...
    String code2 = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractSrcToken036_transferTokenWithViewTest");
    String abi2 = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractSrcToken036_transferTokenWithViewTest");
  ...
  public void deploy05TransferTokenContract() {
    ...
    String code3 = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractSrcToken036_transferTokenWithOutPayableTest");
    String abi3 = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractSrcToken036_transferTokenWithOutPayableTest");
