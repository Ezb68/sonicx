...
public class ContractSrcToken027 {
  ...
  public void deploy01TransferTokenContract() {
    ...
    String code = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractSrcToken027_BTest");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractSrcToken027_BTest");
    ...
    String code1 = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractSrcToken027_CTest");
    String abi1 = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractSrcToken027_CTest");
    ...
    String code2 = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractSrcToken027_tokenTest");
    String abi2 = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractSrcToken027_tokenTest");
