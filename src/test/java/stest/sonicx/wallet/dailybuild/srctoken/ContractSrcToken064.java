...
public class ContractSrcToken064 {
  ...
  public void test01DeployTransferTokenContract() {
    ...
    String code = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractSrcToken064_transferTokenContract");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractSrcToken064_transferTokenContract");
  ...
  public void test02DeployRevContract() {
    ...
    String code = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractSrcToken064_recieveTokenContract");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractSrcToken064_recieveTokenContract");
