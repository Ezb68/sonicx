...
public class ContractSrcToken011 {
  ...
  public void test01DeployTransferTokenContract() {
    ...
    String code = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractSrcToken011_transferTokenContract");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractSrcToken011_transferTokenContract");
  ...
  public void test02DeployRevContract() {
    ...
    String code = Configuration.getByPath("testng.conf")
        .getString("code.code_ContractSrcToken011_resultContract");
    String abi = Configuration.getByPath("testng.conf")
        .getString("abi.abi_ContractSrcToken011_resultContract");
