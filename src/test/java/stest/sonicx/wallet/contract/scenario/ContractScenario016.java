...
import static org.sonicx.protos.Protocol.Transaction.Result.contractResult.BAD_JUMP_DESTINATION_VALUE;
import static org.sonicx.protos.Protocol.Transaction.Result.contractResult.OUT_OF_ENERGY_VALUE;
